package com.luckyaf.smartandroid.utils

import android.util.Log
import com.luckyaf.smartandroid.BuildConfig
import com.luckyaf.smartandroid.extension.isMemberOf
...
object Logger {
    ...
    private var debug =true//是否打印log
    ...
    private val logClassList = ArrayList<String>(
        arrayListOf("com.luckyaf.smartandroid.extension.LogExtKt")
    )
    ...
    fun p(msg: String, tag: String = TAG) = debug.debugPrint(tag, msg, Log.ERROR)
    ...
    private fun getTargetStackTraceElement(): StackTraceElement? {
        ...
        for (stackTraceElement in stackTrace) {
            ...
            val isLogClass = stackTraceClassName == Logger::class.java.name
                    || stackTraceClassName in logClassList
            val isLogMethod = stackTraceElement.methodName.lowercase(Locale.getDefault()).isMemberOf(logMethod)
    ...
    private fun Boolean.debugPrint(tag: String, msg: String, priority: Int) {
        if (!this) {
            return
        }
